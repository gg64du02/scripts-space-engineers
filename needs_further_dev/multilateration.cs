...
public void Main(string argument, UpdateType updateSource)
{
	...
	//generating local (triedre) offset at c1 with (x,y) that can be generated by the (A,D) vectors
	//genere un triedre/repére avec pour origine c1, avec les vecteurs x et y generant un sous espace vectoriel R^2, sous espace vectoriel qui peut être générer pour les vecteurs A et D
