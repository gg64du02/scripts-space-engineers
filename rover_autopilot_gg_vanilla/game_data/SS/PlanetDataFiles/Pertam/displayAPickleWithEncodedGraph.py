...
for nodeStr in arrayOfStr:
    ...
    # print(nodeStr)
    nodePointPosition = [decodeStr__NumberMax4095(nodeStr[0:2]),decodeStr__NumberMax4095(nodeStr[2:4])]
    ...
    for i in range(0,numberOfIndexes):
        arraryNeighboorsIndexes.append(decodeStr__NumberMax4095(nodeStr[6+2*i:6+2*(i+1)]))
        pass
