...
public void Main()
{
    ...
    */
    ...
    { 
        ...
        listRadioAntenna[0].HudText = "\n" + "thr_to_weight_ratio:" + thr_to_weight_ratio;
    }
    */

    List<IMyRemoteControl> listRemoteControl = new List<IMyRemoteControl>();
    GridTerminalSystem.GetBlocksOfType<IMyRemoteControl>(listRemoteControl);

    if (listRemoteControl == null)
    { Echo("no IMyRemoteControl available"); }
    else
    {
        listRemoteControl[0].CustomName = " " + "thr_to_weight_ratio:" + thr_to_weight_ratio;
    }
